    ...
    <nav class="navbar navbar-expand-lg fixed-top" style="background-color: rgb(233, 231, 197)">
        <div class="container">
          <a class="navbar-brand rounded-circle" href="/"><img src="/img/icon.png" width="100px" alt=""></a>
